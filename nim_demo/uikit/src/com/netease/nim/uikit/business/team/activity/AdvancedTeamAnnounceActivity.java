...
public class AdvancedTeamAnnounceActivity extends UI implements TAdapterDelegate {
    ...
    public static void start(Context context, String teamId) {
        start(context, teamId, null);
    }
    public static void start(Context context, String teamId,boolean isok) {
        start(context, teamId, null,isok);
    }
    public static void start(Context context, String teamId, String announceId,boolean isok) {
        Intent intent = new Intent();
        intent.setClass(context, AdvancedTeamAnnounceActivity.class);
    ...
    public static void start(Context context, String teamId, String announceId) {
        Intent intent = new Intent();
        intent.setClass(context, AdvancedTeamAnnounceActivity.class);
        intent.putExtra(EXTRA_TID, teamId);
        if (announceId != null) {
