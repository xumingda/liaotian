...
public class AitManager implements TextWatcher {
    ...
    Handler handler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            if (msg.what==1){
                ...
                if(send){
                    insertAitMemberInner(SharedPrefrenceUtils.getString(context,"account"), SharedPrefrenceUtils.getString(context,"name"), AitContactType.TEAM_MEMBER, curPos, true);
                    SharedPrefrenceUtils.setBoolean(context,"send",false);
                }
    ...
    TimerTask timerTask = new TimerTask() {
        public void run() {
            ...
            send=SharedPrefrenceUtils.getBoolean(context,"send",false);
            if(send){
