package com.netease.nim.zcm.session;
...
import com.netease.nim.zcm.contact.activity.RobotProfileActivity;
import com.netease.nim.zcm.contact.activity.UserProfileActivity;
import com.netease.nim.zcm.jspush.SharedPrefrenceUtils;
import com.netease.nim.zcm.redpacket.NIMRedPacketClient;
import com.netease.nim.zcm.session.action.AVChatAction;
import com.netease.nim.zcm.session.action.AckMessageAction;
import com.netease.nim.zcm.session.action.FileAction;
import com.netease.nim.zcm.session.action.GuessAction;
import com.netease.nim.zcm.session.action.RTSAction;
//import com.netease.nim.zcm.session.action.RedPacketAction;
import com.netease.nim.zcm.session.action.SnapChatAction;
import com.netease.nim.zcm.session.action.TeamAVChatAction;
import com.netease.nim.zcm.session.action.TipAction;
import com.netease.nim.zcm.session.activity.AckMsgInfoActivity;
import com.netease.nim.zcm.session.activity.MessageHistoryActivity;
import com.netease.nim.zcm.session.activity.MessageInfoActivity;
import com.netease.nim.zcm.session.extension.CustomAttachParser;
import com.netease.nim.zcm.session.extension.CustomAttachment;
import com.netease.nim.zcm.session.extension.GuessAttachment;
import com.netease.nim.zcm.session.extension.RTSAttachment;
import com.netease.nim.zcm.session.extension.RedPacketAttachment;
import com.netease.nim.zcm.session.extension.RedPacketOpenedAttachment;
import com.netease.nim.zcm.session.extension.SnapChatAttachment;
import com.netease.nim.zcm.session.extension.StickerAttachment;
import com.netease.nim.zcm.session.search.SearchMessageActivity;
import com.netease.nim.zcm.session.viewholder.MsgViewHolderAVChat;
import com.netease.nim.zcm.session.viewholder.MsgViewHolderDefCustom;
import com.netease.nim.zcm.session.viewholder.MsgViewHolderFile;
import com.netease.nim.zcm.session.viewholder.MsgViewHolderGuess;
import com.netease.nim.zcm.session.viewholder.MsgViewHolderOpenRedPacket;
import com.netease.nim.zcm.session.viewholder.MsgViewHolderRTS;
import com.netease.nim.zcm.session.viewholder.MsgViewHolderRedPacket;
import com.netease.nim.zcm.session.viewholder.MsgViewHolderSnapChat;
import com.netease.nim.zcm.session.viewholder.MsgViewHolderSticker;
import com.netease.nim.zcm.session.viewholder.MsgViewHolderTip;
...
//                AitManager aitManager = new AitManager(context, message.getSessionId(), false);
//                AitContactSelectorActivity.start(context, message.getSessionId(), false);

                if(!message.getFromAccount().equals(NimUIKit.getAccount())){
                    SharedPrefrenceUtils.setString(context,"account",message.getFromAccount());
                    SharedPrefrenceUtils.setString(context,"name",message.getFromNick());
                    SharedPrefrenceUtils.setBoolean(context,"send",true);
                }
