...
import com.netease.nim.zcm.contact.activity.UserProfileSettingActivity;
import com.netease.nim.zcm.jsbridge.JsBridgeActivity;
import com.netease.nim.zcm.jspush.SharedPrefrenceUtils;
import com.netease.nim.zcm.jspush.TagAliasOperatorHelper;
import com.netease.nim.zcm.main.adapter.SettingsAdapter;
import com.netease.nim.zcm.main.model.SettingTemplate;
import com.netease.nim.zcm.main.model.SettingType;
...
import static com.netease.nim.zcm.jspush.TagAliasOperatorHelper.ACTION_DELETE;
...
//                                      UserPreferences.isDeleteFriendAndDeleteAlias()));
    ...
    private void logout() {
        deleteAlias();
        SharedPrefrenceUtils.setBoolean(this,"isSetAlias",false);
    ...
    private void deleteAlias() {
        ...
        tagAliasBean.alias = NimUIKit.getAccount();
        sequence++;
