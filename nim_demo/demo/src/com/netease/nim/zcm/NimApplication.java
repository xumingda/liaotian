...
import com.netease.nim.zcm.chatroom.ChatRoomSessionHelper;
import com.netease.nim.zcm.common.util.LogHelper;
import com.netease.nim.zcm.common.util.crash.AppCrashHandler;
import com.netease.nim.zcm.config.preference.Preferences;
import com.netease.nim.zcm.config.preference.UserPreferences;
import com.netease.nim.zcm.contact.ContactHelper;
import com.netease.nim.zcm.event.DemoOnlineStateContentProvider;
import com.netease.nim.zcm.main.activity.MainActivity;
import com.netease.nim.zcm.main.activity.WelcomeActivity;
import com.netease.nim.zcm.mixpush.DemoMixPushMessageHandler;
import com.netease.nim.zcm.mixpush.DemoPushContentProvider;
import com.netease.nim.zcm.rts.RTSHelper;
import com.netease.nim.zcm.session.NimDemoLocationProvider;
...
public class NimApplication extends Application {
    ...
    public void onCreate() {
        ...
        //SDK初始化
        TestinDataApi.init(this, "81a1fb6ca1958a46c43ef1a252896c13", testinDataConfig);
