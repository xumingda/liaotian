package com.netease.nim.zcm.contact.activity;
...
import com.netease.nim.zcm.config.preference.UserPreferences;
import com.netease.nim.uikit.common.ToastHelper;

import com.netease.nim.zcm.DemoCache;
import com.netease.nim.zcm.R;
import com.netease.nim.zcm.contact.constant.UserConstant;
import com.netease.nim.zcm.main.model.Extras;
...
public class UserProfileActivity extends UI {
    ...
    private final boolean FLAG_ADD_FRIEND_DIRECTLY = false; //xmd 是否直接加为好友开关，false为需要好友申请
    ...
    private TextView signatureText,login_time;
        ...
        public void handleMessage(Message msg){
            ...
            if(msg.what==100){
                ...
                if(!TextUtils.isEmpty(time)){
                    login_time.setText("最后一次登录时间："+time.substring(1,time.length()-1));
                }
                ...
                ToastHelper.showToast(NimUIKit.getContext(),"您已被禁止私加好友");
            }
        }
    };

    private void findViews() {
        login_time = findView(R.id.login_time);
        ...
        new Thread(new Runnable(){
            ...
            public void run() {
                ...
                bundle.putString("time", getLastLoginTime(account));
...
//            toolbarView.setVisibility(View.VISIBLE);
    ...
    private void updateToggleView() {
        if (DemoCache.getAccount() != null && !DemoCache.getAccount().equals(account)) {
            ...
            if (noticeSwitch == null) {
                noticeSwitch = addToggleItemView(KEY_MSG_NOTICE, R.string.tebieguanzhu, notice);
            } else {
    ...
    /**获取最后登录时间**/
    public static String getLastLoginTime(String account){
        //get的方式提交就是url拼接的方式
        String path = "http://im.hjtgn.cn/api/getLastLoginTime?account="+account;
        try {
